...
declare namespace Env {
  ...
  interface ImportMeta extends ImportMetaEnv {
    ...
    /**
     * WebSocket url for live vehicle position push
     *
     * Leave empty to derive it from the current page host (production goes through the same nginx)
     */
     ...
     *
     * Required when the key has a security code bound in the AMap console; it must be set before the
     * script loads, otherwise every request fails with INVALID_USER_SCODE
     */
